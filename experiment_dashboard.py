...
if 'laptop_ip' not in st.session_state: st.session_state.laptop_ip = "192.168.7.98"
...
with left_col:
    ...
    # 5. Post Process
    st.write("---")
    if st.button("RUN Post Process", width="stretch"):
        with st.spinner("Running analysis..."):
            subprocess.run(["python", str(POST_PROCESS_SCRIPT)])
